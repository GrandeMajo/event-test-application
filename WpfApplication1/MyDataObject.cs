...
namespace WpfApplication1
{
    ...
    public class MyDataObject : System.Windows.IDataObject, IComDataObject
    {
        ...
        private System.Windows.IDataObject innerData = null;
        ...
        /// </devdoc>
        internal MyDataObject(System.Windows.IDataObject data)
        {
            innerData = data;
        }
        ...
        /// </devdoc>
        internal MyDataObject(IComDataObject data)
        {
            if (data is System.Windows.DataObject)
            {
                innerData = data as System.Windows.IDataObject;
            }
            else
            {
                innerData = (System.Windows.IDataObject)new OleConverter(data);
            }
        }
        ...
        public MyDataObject()
        {
            innerData = (System.Windows.IDataObject)new DataStore();
        }
        ...
        {
            if (data is System.Windows.IDataObject && !Marshal.IsComObject(data))
            {
                innerData = (System.Windows.IDataObject)data;
            }
            else if (data is IComDataObject)
            {
                innerData = (System.Windows.IDataObject)new OleConverter((IComDataObject)data);
            }
            else
            {
                innerData = (System.Windows.IDataObject)new DataStore();
        ...
        /// </devdoc>
        public MyDataObject(string format, object data) : this()
        {
            SetData(format, data);
        }
        ...
        {
            return GetDataPresent(System.Windows.DataFormats.WaveAudio, false);
        }
        ...
        {
            return GetDataPresent(System.Windows.DataFormats.FileDrop, true);
        }
        ...
        {
            return GetDataPresent(System.Windows.DataFormats.Bitmap, true);
        }
        ...
        {
            return ContainsText(System.Windows.TextDataFormat.UnicodeText);
        }
        ...
        ///    <para>[To be supplied.]</para>
        /// </devdoc>
        public virtual bool ContainsText(System.Windows.TextDataFormat format)
        {
            //valid values are 0x0 to 0x4
            if (!ClientUtils.IsEnumValid(format, (int)format, (int)System.Windows.TextDataFormat.Text, (int)System.Windows.TextDataFormat.CommaSeparatedValue))
            {
                throw new InvalidEnumArgumentException("format", (int)format, typeof(System.Windows.TextDataFormat));
            }
        ...
        {
            return GetData(System.Windows.DataFormats.WaveAudio, false) as Stream;
        }
        ...
        public virtual StringCollection GetFileDropList()
        {
            ...
            string[] strings = GetData(System.Windows.DataFormats.FileDrop, true) as string[];
            if (strings != null)
            {
        ...
        {
            return GetData(System.Windows.DataFormats.Bitmap, true) as System.Drawing.Image;
        }
        ...
        {
            return GetText(System.Windows.TextDataFormat.UnicodeText);
        }
        ...
        ///    <para>[To be supplied.]</para>
        /// </devdoc>
        public virtual string GetText(System.Windows.TextDataFormat format)
        {
            //valid values are 0x0 to 0x4
            if (!ClientUtils.IsEnumValid(format, (int)format, (int)System.Windows.TextDataFormat.Text, (int)System.Windows.TextDataFormat.CommaSeparatedValue))
            {
        ...
        public virtual void SetAudio(Stream audioStream)
        {
            ...
            SetData(System.Windows.DataFormats.WaveAudio, false, audioStream);
        }
        ...
        public virtual void SetFileDropList(StringCollection filePaths)
        {
            ...
            SetData(System.Windows.DataFormats.FileDrop, true, strings);
        }
        ...
        public virtual void SetImage(System.Drawing.Image image)
        {
            ...
            SetData(System.Windows.DataFormats.Bitmap, true, image);
        }
        ...
        {
            SetText(textData, System.Windows.TextDataFormat.UnicodeText);
        }
        ...
        ///    <para>[To be supplied.]</para>
        /// </devdoc>
        public virtual void SetText(string textData, System.Windows.TextDataFormat format)
        {
        ...
        private static string ConvertToDataFormats(System.Windows.TextDataFormat format)
        {
            switch (format)
            {
                ...
                case System.Windows.TextDataFormat.CommaSeparatedValue:
                    return System.Windows.DataFormats.CommaSeparatedValue;
            }
        ...
        private static string[] GetMappedFormats(string format)
        {
            ...
            if (format.Equals(System.Windows.DataFormats.Text)
                || format.Equals(System.Windows.DataFormats.UnicodeText)
                || format.Equals(System.Windows.DataFormats.StringFormat))
            {
            ...
            if (format.Equals(System.Windows.DataFormats.FileDrop)
            ...
            if (format.Equals(System.Windows.DataFormats.Bitmap)
            ...
            /*gpr
                    if (format.Equals(System.Windows.DataFormats.EnhancedMetafile)
                        || format.Equals((typeof(Metafile)).FullName)) {

                        return new string[] {System.Windows.DataFormats.EnhancedMetafile,
        ...
        */
                                           ...
                                           ref STGMEDIUM medium)
        {
            ...
            {
                string format = System.Windows.DataFormats.GetFormat(formatetc.cfFormat).Name;
                ...
                if (GetDataPresent(format))
                {
                    ...
                    {
                        if (format.Equals(System.Windows.DataFormats.Bitmap) && data is Bitmap)
                        {
                            // save bitmap
                            //
        ...
        int IComDataObject.QueryGetData(ref FORMATETC formatetc)
        {
            ...
            if (formatetc.dwAspect == DVASPECT.DVASPECT_CONTENT)
            {
                if (GetTymedUseable(formatetc.tymed))
                {
                    ...
                    {
                        if (!GetDataPresent(System.Windows.DataFormats.GetFormat(formatetc.cfFormat).Name))
                        {
        ...
        private int SaveDataToHandle(object data, string format, ref STGMEDIUM medium)
        {
            ...
            else if (format.Equals(System.Windows.DataFormats.Text)
                     || format.Equals(System.Windows.DataFormats.Rtf)
                     || format.Equals(System.Windows.DataFormats.OemText))
            {
                hr = SaveStringToHandle(medium.unionmember, data.ToString(), false);
            }
            else if (format.Equals(System.Windows.DataFormats.Html))
            {
            ...
            else if (format.Equals(System.Windows.DataFormats.UnicodeText))
            {
                hr = SaveStringToHandle(medium.unionmember, data.ToString(), true);
            }
            else if (format.Equals(System.Windows.DataFormats.FileDrop))
            {
            ...
            else if (format.Equals(System.Windows.DataFormats.Dib)
            ...
            else if (format.Equals(System.Windows.DataFormats.Serializable)
        ...
        */
        ...
        private class FormatEnumerator : IEnumFORMATETC
        {
            ...
            internal System.Windows.IDataObject parent = null;
            internal ArrayList formats = new ArrayList();
            internal int current = 0;

            public FormatEnumerator(System.Windows.IDataObject parent) : this(parent, parent.GetFormats())
            {
            }

            public FormatEnumerator(System.Windows.IDataObject parent, FORMATETC[] formats)
            {
                this.formats.Clear();
                this.parent = parent;
                current = 0;
                if (formats != null)
                {
                    MyDataObject dataObject = parent as MyDataObject;
                    if (dataObject != null && dataObject.RestrictedFormats)
                    {
                        if (!System.Windows.Clipboard.IsFormatValid(formats))
                        {
            ...
            public FormatEnumerator(System.Windows.IDataObject parent, string[] formats)
            {

                this.parent = parent;
                this.formats.Clear();

                string bitmap = System.Windows.DataFormats.Bitmap;
                string emf = System.Windows.DataFormats.EnhancedMetafile;
                string text = System.Windows.DataFormats.Text;
                string unicode = System.Windows.DataFormats.UnicodeText;
                string standard = System.Windows.DataFormats.StringFormat;
                string str = System.Windows.DataFormats.StringFormat;
                ...
                if (formats != null)
                {
                    ...
                    for (int i = 0; i < formats.Length; i++)
                    {
                        ...
                        FORMATETC temp = new FORMATETC();
                        temp.cfFormat = unchecked((short)(ushort)(System.Windows.DataFormats.GetFormat(format).Id));
                        ...
                        else if (format.Equals(emf))
                        {
                            temp.tymed = TYMED.TYMED_ENHMF;
                                 ...
                                 || format.Equals(str)
                                 || format.Equals(System.Windows.DataFormats.Rtf)
                                 || format.Equals(System.Windows.DataFormats.CommaSeparatedValue)
                                 || format.Equals(System.Windows.DataFormats.FileDrop)
                                 || format.Equals(CF_DEPRECATED_FILENAME)
                                 || format.Equals(CF_DEPRECATED_FILENAMEW))
                        {
        ...
        private class OleConverter : IDataObject
        {
            ...
            private Object GetDataFromOleIStream(string format)
            {
                ...
                formatetc.cfFormat = unchecked((short)(ushort)(System.Windows.DataFormats.GetFormat(format).Id));
            ...
            private Object GetDataFromHGLOBLAL(string format, IntPtr hglobal)
            {
                ...
                if (hglobal != IntPtr.Zero)
                {
                    ...
                    else
                    {
                        ...
                        if (format.Equals(System.Windows.DataFormats.Dib)
                            && data is Stream) {
            ...
            private Object GetDataFromOleOther(string format)
            {
                ...
                else if (format.Equals(System.Windows.DataFormats.EnhancedMetafile))
                {
                ...
                if (medium.unionmember != IntPtr.Zero)
                {
                    ...
                    if (format.Equals(System.Windows.DataFormats.Bitmap)
                        //||format.Equals(System.Windows.DataFormats.Dib))
                    )
                    {
            ...
            public virtual void SetData(Object data)
            {
                ...
                {
                    SetData(System.Windows.DataFormats.Serializable, data);
                }
                else
                {
            ...
            public virtual string[] GetFormats(bool autoConvert)
            {
                ...
                if (enumFORMATETC != null)
                {
                    ...
                    while (retrieved[0] > 0)
                    {
                        ...
                        if (retrieved[0] > 0)
                        {
                            string name = System.Windows.DataFormats.GetFormat(formatetc[0].cfFormat).Name;
                            if (autoConvert)
                            {
        ...
        private class DataStore : IDataObject
        {
            ...
            public virtual void SetData(string format, bool autoConvert, Object data)
            {
                ...
                //
                if (data is Bitmap && format.Equals(System.Windows.DataFormats.Dib))
                {
                    if (autoConvert)
                    {
                        format = System.Windows.DataFormats.Bitmap;
                    }
                    else
                    {
            ...
            {
                if (data is ISerializable
                    && !this.data.ContainsKey(System.Windows.DataFormats.Serializable))
                {
